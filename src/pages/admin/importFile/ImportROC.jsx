...
const formatData = async (csvData) => {
  ...
  for (const item of removedArray) {
    const result = await formatRoc(item);
  ...
  return (
    <div className=" p-6 w-full ">
      <ToastContainer
        ...
        transition={Bounce}
      />
      <h1 className="text-xl font-bold mb-4 text-left">{STRINGS.IMPORT_ROC}</h1>
